...
* [**tests/test_models**](./tests/test_models) **:** <ins>**is a Folder of Project test files<ins>.** <br>
...
* All your classes should be documented: ([**python3 -c 'print(__import__("my_module").MyClass.__doc__)'**](./tests/test_models/base.py))
